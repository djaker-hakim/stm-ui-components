...
$checkboxes = [
    'standard' => [
        ...
        'input' => "peer h-5 w-5 cursor-pointer transition-all appearance-none rounded shadow hover:shadow-md border border-slate-300 checked:bg-[$color] checked:border-[$color] disabled:bg-[var(--stm-ui-muted)] disabled:opacity-60 $inputClass",
        'icon' => "absolute h-3.5 w-3.5 text-white opacity-0 peer-checked:opacity-100 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none $iconClass"
    ],
    'custom' => [
